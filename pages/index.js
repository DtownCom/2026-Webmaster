/* ============================================================
   SITE-WIDE SEARCH
   - Shows live dropdown results across all site sections
   - Each result has a title, category badge, snippet & link
   - Keyboard navigable (↑ ↓ Enter Escape)
   - Highlights matched text in-page when a result is clicked
   ============================================================ */
